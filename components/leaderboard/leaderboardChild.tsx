...
export default function LeaderboardChild({
	...
	discriminator,
	avatarURL,
}: LeaderboardChildRankingsInterface) {
	...
	return (
		<motion.li
			...
			className="transition duration-300 ease-in-out bg-gray-900 flex flex-wrap items-center w-full my-4 p-2 px-4 rounded-lg group hover:bg-gray-700 hover:bg-opacity-80 shadow overflow-hidden"
		>
			<div className="flex-shrink-0 w-72 truncate text-gray-700 text-left">
				...
				<span className="transition duration-300 ease-in-out text-gray-400 group-hover:text-gray-400">
					<span className="transition duration-300 ease-in-out text-gray-200 group-hover:text-white">{username}</span>
