    ...
    return (
      <div>
          ...
          <div className='flex-shrink-0 truncate text-gray-700 text-left'>
            ...
            <img className='w-32 rounded-full inline-block mx-4 whitespace-nowrap overflow-hidden' src={avatarURL} alt={`${name}'s Avatar`} style={{textIndent: '100%'}}></img>
        ...
        {disciple === true && 
          ...
          <div className='flex-shrink-0 truncate text-gray-700 text-left'>
            ...
            <img className=' w-24 rounded-full inline-block mx-4 whitespace-nowrap overflow-hidden' src={avatarURL} alt={`${name}'s Avatar`} style={{textIndent: '100%'}}></img>
            <span className="transition duration-300 ease-in-out text-gray-400 group-hover:text-gray-400">
                {/* 
              <span className="transition duration-300 ease-in-out text-gray-200 group-hover:text-white">
                  {name}
        ...
        {enthusiast === true && 
          ...
          <div className='flex-shrink-0 truncate text-gray-700 text-left'>
            ...
            <img className=' w-16 rounded-full inline-block mx-4 whitespace-nowrap overflow-hidden' src={avatarURL} alt={`${name}'s Avatar`} style={{textIndent: '100%'}}></img>
            <span className="transition duration-300 ease-in-out text-gray-400 group-hover:text-gray-400">
                {/* 
              <span className="transition duration-300 ease-in-out text-gray-200 group-hover:text-white">
                  {name}
          ...
          <div className='flex-grow lg:p-4 w-full md:w-auto overflow-hidden'>
            <div className='transition duration-1000 ease-in-out text-white text-center lg:text-left overflow-hidden text-base lg:text-lg'>
              {name}
            </div>
            {/*
            <div className='transition duration-300 ease-in-out mt-1 mb-1 w-full h-1 bg-gray-700 group-hover:bg-gray-500 rounded overflow-hidden'>
        ...
        {follower === true && 
          ...
          <div className='flex-shrink-0 truncate text-gray-700 text-left'>
            ...
            <img className=' w-12 mt-4 lg:mt-0 rounded-full inline-block mx-4 whitespace-nowrap overflow-hidden' src={avatarURL} alt={`${name}'s Avatar`} style={{textIndent: '100%'}}></img>
            <span className="transition duration-300 ease-in-out text-gray-400 group-hover:text-gray-400">
                {/* 
              <span className="transition duration-300 ease-in-out text-gray-200 group-hover:text-white">
                  {name}
