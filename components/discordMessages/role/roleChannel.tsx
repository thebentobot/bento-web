		...
		<DiscordMessages>
			<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b" timestamp={moment().toDate()}>
				<DiscordEmbedDescription slot="description">
					...
					<br />
					<br />
					The <strong>News</strong> role is if you want updates about Bento regarding new features, technical issues,
					downtime, bugs etc.
				</DiscordEmbedDescription>
				<DiscordEmbed slot="embeds" title="Available Roles" color="#ffe9a4">
					<DiscordEmbedFields slot="fields">
						<DiscordEmbedField fieldTitle="Main Roles" inline inlineIndex={1}>
							<code>Tester</code>, <code>Co-Developer</code>
						</DiscordEmbedField>
						<DiscordEmbedField fieldTitle="Sub Roles" inline inlineIndex={1}>
							<code>News</code>
						</DiscordEmbedField>
						<DiscordEmbedField fieldTitle="Other Roles" inline inlineIndex={1}>
							<code>Beer</code>
						</DiscordEmbedField>
					</DiscordEmbedFields>
				</DiscordEmbed>
			...
			<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
				<DiscordEmbed slot="embeds" title="Fiji Spring Water#1949" color="#FFFFFF">
					<DiscordEmbedFields slot="fields">
						<DiscordEmbedField fieldTitle="Assigned Roles" inline inlineIndex={1}>
							Beer
						</DiscordEmbedField>
					</DiscordEmbedFields>
				</DiscordEmbed>
