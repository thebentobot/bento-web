...
export default function PrefixExample() {
    return (
        <DiscordMessages>
            <DiscordMessage timestamp='08/15/2021' author="Adam" avatar="/adam.webp" roleColor='#00B2FF' highlight><DiscordMention>Bento</DiscordMention> time tokyo</DiscordMessage>
