	...
	return (
		<DiscordMessages>
			...
			<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
				<strong>tzuwy</strong>, you can give someone a <strong>Bento Box 🍱</strong> again in 1 hours, 22 minutes and 16
				seconds
			</DiscordMessage>
			...
			<DiscordMessage author="Tzuwy" avatar="/tzuwy.webp" roleColor="#f0dacb">
				<DiscordAttachment
					slot="attachments"
					url="https://cdn.discordapp.com/emojis/864322844342222858.gif?v=1"
					height={48}
					width={48}
				></DiscordAttachment>
			</DiscordMessage>
