...
export default function Notification() {
	return (
		<div>
			...
			<DiscordMessages>
				<DiscordMessage author="Adam" avatar="/adam.webp" roleColor="#00B2FF">
					?notification add pizza
				</DiscordMessage>
			</DiscordMessages>
			<p className="text-xl py-2 whitespace-pre-line text-gray-300 text-opacity-50 sm:text-xl group-hover:text-opacity-100 text-center max-w-xl mx-auto">
				...
				<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
					<DiscordEmbed slot="embeds" color="#ffd903">
						<DiscordEmbedDescription slot="description">
							...
							<br />
							You will be notified when your notification content are mentioned on the server you saved it on. Use the
							global argument for the notification command to enable global notifications.
						</DiscordEmbedDescription>
					</DiscordEmbed>
				</DiscordMessage>
			</DiscordMessages>
			...
			<DiscordMessages>
				<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
					Link to message:
					<br />
					<Link href="https://discord.com/channels/714496317522444352/714825604838719570/872462217587601508">
						https://discord.com/channels/714496317522444352/714825604838719570/872462217587601508
					</Link>
					<DiscordEmbed
						slot="embeds"
						color="#ffd903"
						...
						thumbnail={tzuwyAvatar}
					>
						<DiscordEmbedDescription slot="description">
							🗨️ tzuwy#0001 mentioned <code>pizza</code> in <DiscordMention type="channel">general</DiscordMention> on{" "}
							<strong>Bento Bot</strong>.
							<br />
							Link to the message{" "}
							<Link href="https://discord.com/channels/714496317522444352/714825604838719570/872462217587601508">
								here
				...
				<DiscordMessage author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
					<DiscordEmbed slot="embeds" embedTitle="Your saved notifications" color="#ffd903" thumbnail={adamAvatar}>
						<DiscordEmbedDescription slot="description">
							...
							<span slot="footer">
								Notifications marked with (G) is enabled globally. <br /> Notifications in total: 3.{" "}
							</span>
						</DiscordEmbedDescription>
					</DiscordEmbed>
				</DiscordMessage>
			...
			<p className="text-xl py-2 whitespace-pre-line text-gray-300 text-opacity-50 sm:text-xl group-hover:text-opacity-100 text-center max-w-xl mx-auto">
				At last, you can both save a keyword for global notifications by adding <strong>--global</strong> when saving
				your keyword,
			...
			<DiscordMessages>
				...
				<DiscordMessage highlight author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
					<DiscordMention>Adam</DiscordMention> Your notification was just <code>enabled</code> globally.
				</DiscordMessage>
				<DiscordMessage author="Adam" avatar="/adam.webp" roleColor="#00B2FF">
					?noti global pizza
				</DiscordMessage>
				<DiscordMessage highlight author="Bento" avatar="/bento.png" bot verified roleColor="#f9d61b">
					<DiscordMention>Adam</DiscordMention> Your notification was just <code>disabled</code> globally.
				</DiscordMessage>
			</DiscordMessages>
		</div>
	);
