...
export default function CaseEdit() {
    return (
        <DiscordMessages>
            <DiscordMessage author="Banner" avatar="/banner.webp" roleColor='#ff00fa'>?case edit warning 1 note he may get the mute mask in the future muahaha</DiscordMessage>
