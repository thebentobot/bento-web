<script lang="ts">
    ...
    let {
        ...
        fmSongTextColour = $bindable("#ffffff"),
...
<div class="grid gap-3">
    <ColorOpacityPicker
        ...
        bind:color={fmDivBgcolour}
        bind:opacity={fmDivBgopacity}
    />
    <ColorOpacityPicker
        label="Song Text"
        bind:color={fmSongTextColour}
        bind:opacity={fmSongTextOpacity}
    />
    <ColorOpacityPicker
        label="Artist Text"
        bind:color={fmArtistTextColour}
