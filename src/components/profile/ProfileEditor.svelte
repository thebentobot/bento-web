    ...
    <div>
        ...
        <div class="mt-4 flex flex-col items-center gap-3">
            <div class="flex items-center gap-3">
                <SaveResetButtons {saving} {hasChanges} onSave={saveProfile} onReset={resetChanges} />
    ...
    {#if showModal}
        <ModalShell title={`Edit ${selectedTarget}`} onClose={() => (showModal = false)}>
            {#if selectedTarget === "background"}
                <BackgroundSection
                    bind:backgroundUrl={() => profile.BackgroundUrl ?? "", (v) => (profile.BackgroundUrl = v || null)}
                    bind:backgroundColour={() => profile.BackgroundColour ?? "#1F2937", (v) => (profile.BackgroundColour = v)}
                    bind:backgroundColourOpacity={() => profile.BackgroundColourOpacity ?? 100, (v) => (profile.BackgroundColourOpacity = v)}
                    bind:overlayColour={() => profile.OverlayColour ?? "#000000", (v) => (profile.OverlayColour = v)}
                    bind:overlayOpacity={() => profile.OverlayOpacity ?? 20, (v) => (profile.OverlayOpacity = v)}
                    bind:lastfmBoard={() => !!profile.LastfmBoard, (v) => (profile.LastfmBoard = !!v)}
                    bind:xpBoard={() => !!profile.XpBoard, (v) => (profile.XpBoard = !!v)}
                />
            {:else if selectedTarget === "description"}
                <DescriptionSection
                    bind:description={() => profile.Description ?? "", (v) => (profile.Description = v)}
                    bind:descriptionColour={() => profile.DescriptionColour ?? "#ffffff", (v) => (profile.DescriptionColour = v)}
                    bind:descriptionColourOpacity={() => profile.DescriptionColourOpacity ?? 100, (v) => (profile.DescriptionColourOpacity = v)}
                />
            {:else if selectedTarget === "sidebar"}
                <SidebarSection
                    bind:sidebarColour={() => profile.SidebarColour ?? "#000000", (v) => (profile.SidebarColour = v)}
                    bind:sidebarOpacity={() => profile.SidebarOpacity ?? 30, (v) => (profile.SidebarOpacity = v)}
                    bind:sidebarBlur={() => profile.SidebarBlur ?? 3, (v) => (profile.SidebarBlur = v)}
                    bind:usernameColour={() => profile.UsernameColour ?? "#ffffff", (v) => (profile.UsernameColour = v)}
                    bind:discriminatorColour={() => profile.DiscriminatorColour ?? "#9CA3AF", (v) => (profile.DiscriminatorColour = v)}
                    bind:sidebarItemServerColour={() => profile.SidebarItemServerColour ?? "#D3D3D3", (v) => (profile.SidebarItemServerColour = v)}
                    bind:sidebarValueServerColour={() => profile.SidebarValueServerColour ?? "#ffffff", (v) => (profile.SidebarValueServerColour = v)}
                    bind:sidebarItemGlobalColour={() => profile.SidebarItemGlobalColour ?? "#D3D3D3", (v) => (profile.SidebarItemGlobalColour = v)}
                    bind:sidebarValueGlobalColour={() => profile.SidebarValueGlobalColour ?? "#ffffff", (v) => (profile.SidebarValueGlobalColour = v)}
                    bind:sidebarItemBentoColour={() => profile.SidebarItemBentoColour ?? "#D3D3D3", (v) => (profile.SidebarItemBentoColour = v)}
                    bind:sidebarValueBentoColour={() => profile.SidebarValueBentoColour ?? "#ffffff", (v) => (profile.SidebarValueBentoColour = v)}
                    bind:sidebarItemTimezoneColour={() => profile.SidebarItemTimezoneColour ?? "#D3D3D3", (v) => (profile.SidebarItemTimezoneColour = v)}
            ...
            {:else if selectedTarget === "lastfm"}
                <LastfmSection
                    bind:fmDivBgcolour={() => profile.FmDivBgcolour ?? "#111827", (v) => (profile.FmDivBgcolour = v)}
                    bind:fmDivBgopacity={() => profile.FmDivBgopacity ?? 100, (v) => (profile.FmDivBgopacity = v)}
                    bind:fmSongTextColour={() => profile.FmSongTextColour ?? "#ffffff", (v) => (profile.FmSongTextColour = v)}
                    bind:fmSongTextOpacity={() => profile.FmSongTextOpacity ?? 100, (v) => (profile.FmSongTextOpacity = v)}
                    bind:fmArtistTextColour={() => profile.FmArtistTextColour ?? "#ffffff", (v) => (profile.FmArtistTextColour = v)}
                    bind:fmArtistTextOpacity={() => profile.FmArtistTextOpacity ?? 100, (v) => (profile.FmArtistTextOpacity = v)}
                />
            {:else if selectedTarget === "xp"}
                <XpSection
                    bind:xpDivBgcolour={() => profile.XpDivBgcolour ?? "#111827", (v) => (profile.XpDivBgcolour = v)}
                    bind:xpDivBgopacity={() => profile.XpDivBgopacity ?? 100, (v) => (profile.XpDivBgopacity = v)}
                    bind:xpTextColour={() => profile.XpTextColour ?? "#ffffff", (v) => (profile.XpTextColour = v)}
                    bind:xpTextOpacity={() => profile.XpTextOpacity ?? 100, (v) => (profile.XpTextOpacity = v)}
                    bind:xpText2Colour={() => profile.XpText2Colour ?? "#ffffff", (v) => (profile.XpText2Colour = v)}
                    bind:xpText2Opacity={() => profile.XpText2Opacity ?? 100, (v) => (profile.XpText2Opacity = v)}
                    bind:xpBarColour={() => profile.XpBarColour ?? "#374151", (v) => (profile.XpBarColour = v)}
                    bind:xpBarOpacity={() => profile.XpBarOpacity ?? 100, (v) => (profile.XpBarOpacity = v)}
                    bind:xpBar2Colour={() => profile.XpBar2Colour ?? "#374151", (v) => (profile.XpBar2Colour = v)}
                    bind:xpBar2Opacity={() => profile.XpBar2Opacity ?? 100, (v) => (profile.XpBar2Opacity = v)}
                    bind:xpDoneServerColour1={() => profile.XpDoneServerColour1 ?? "#FCD34D", (v) => (profile.XpDoneServerColour1 = v)}
                    bind:xpDoneServerColour1Opacity={() => profile.XpDoneServerColour1Opacity ?? 100, (v) => (profile.XpDoneServerColour1Opacity = v)}
                    bind:xpDoneServerColour2={() => profile.XpDoneServerColour2 ?? "#F59E0B", (v) => (profile.XpDoneServerColour2 = v)}
                    bind:xpDoneServerColour2Opacity={() => profile.XpDoneServerColour2Opacity ?? 100, (v) => (profile.XpDoneServerColour2Opacity = v)}
                    bind:xpDoneServerColour3={() => profile.XpDoneServerColour3 ?? "#EF4444", (v) => (profile.XpDoneServerColour3 = v)}
                    bind:xpDoneServerColour3Opacity={() => profile.XpDoneServerColour3Opacity ?? 100, (v) => (profile.XpDoneServerColour3Opacity = v)}
                    bind:xpDoneGlobalColour1={() => profile.XpDoneGlobalColour1 ?? "#FCD34D", (v) => (profile.XpDoneGlobalColour1 = v)}
                    bind:xpDoneGlobalColour1Opacity={() => profile.XpDoneGlobalColour1Opacity ?? 100, (v) => (profile.XpDoneGlobalColour1Opacity = v)}
                    bind:xpDoneGlobalColour2={() => profile.XpDoneGlobalColour2 ?? "#F59E0B", (v) => (profile.XpDoneGlobalColour2 = v)}
                    bind:xpDoneGlobalColour2Opacity={() => profile.XpDoneGlobalColour2Opacity ?? 100, (v) => (profile.XpDoneGlobalColour2Opacity = v)}
                    bind:xpDoneGlobalColour3={() => profile.XpDoneGlobalColour3 ?? "#EF4444", (v) => (profile.XpDoneGlobalColour3 = v)}
