		...
		<div>
			...
			<NextSeo
				...
				additionalMetaTags={[
					{
						name: "summary",
						content: "About Bento 🍱 - The best Discord bot available, and how it was created",
					},
				]}
			/>
			<div className="py-6 lg:py-12 bg-gray-800">
				...
				>
					<div className="lg:text-center">
						...
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							Bento 🍱 was started as a project to learn JavaScript and programming in general, and is a project of
							continuous learning and improvement.
						</p>
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							<strong>The goal</strong> for Bento 🍱 is to create <strong>joy</strong>. Joy for the users by always
							being reliable and deliver commands as expected. Make their chatting experience more fun and easier on
							Discord.
						</p>
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							...
							, where the raised funding is spend solely on hosting and improving Bento 🍱. If you are interested in
							reading about supporting, then{" "}
							<a className="text-yellow-300 hover:underline">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<motion.div className="lg:text-center" initial="hidden" animate="show" variants={animation}>
						...
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							...
							<Link href="https://nextjs.org/" target="_blank" rel="noreferrer" className="text-white hover:underline">
								Next.js
							</Link>{" "}
							and{" "}
							<Link
						...
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							...
							where ideas, discussion, feedback and bug reporting are happening, besides just chatting. Everyone is
							welcome to join!
						</p>
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							Logo drawn by{" "}
