			...
			>
				...
				>
					...
					<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto sm:text-center sm:max-w-xl mx-auto text-center">
						Bento 2.0 🍱 is a huge improvement over the previous iteration of Bento 🍱 and a foundational change in
						terms of visions for the future of the project.
					</p>
					<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto sm:text-center sm:max-w-xl mx-auto text-center">
						Improving overall infrastructure and reliability, implementing new Discord API features such as Slash
						Commands, Select Menus and Buttons.
					</p>
					<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto sm:text-center sm:max-w-xl mx-auto text-center">
						The focus for the future will be on <strong>media and entertainment commands</strong>, which means that
						moderation commands will be deprecated.
					</p>
				</motion.div>
				<p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-yellow-300 sm:text-4xl text-center">
				...
				<div className="mt-10">
					<dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
						{features.map((feature) => (
							<motion.div
								key={feature.name}
								className="relative bg-gray-900 px-6 py-6 rounded shadow-lg"
								whileHover={{
									scale: 1.02,
								}}
								initial="hidden"
