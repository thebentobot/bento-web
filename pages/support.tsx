		...
		<div>
			...
			<NextSeo
				...
				additionalMetaTags={[
					{
						name: "summary",
						content: "How to support Bento 🍱 - The best free Discord bot available",
					},
				]}
			/>
			...
			<div className="py-12 bg-gray-900">
				...
				>
					<div className="lg:text-center">
						...
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
							By supporting Bento 🍱, you are an important part of ensuring that the performance of Bento 🍱 is always
							stellar, the experience is top quality and a joy for thousands of Discord users, and available for free
							for everyone. <strong>Everyone deserves free essential Discord Server features</strong>.
						</p>
						<p className="mt-4 max-w-2xl text-xl text-gray-300 lg:mx-auto text-center mx-auto">
