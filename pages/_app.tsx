...
function MyApp({ Component, pageProps }: AppProps) {
	...
	return pageLoaded === false ? null : (
		<div className="bg-gray-800 flex flex-col min-h-screen">
			<script>const theme = localStorage.getItem(`theme``) || `light``; document.body.className = theme;</script>
			<Head>
				...
				<link rel="mask-icon" href="../public/safari-pinned-tab.svg" color="#ffd903" />
			...
			<div className="fixed bottom-3 bg-yellow-300 right-3  cursor-pointer z-50">
				{isVisible && <ScrollButton scrollToTop={scrollToTop} />}
			</div>
			<html lang="en" />
			<Navigation />
			<Component {...pageProps} />
